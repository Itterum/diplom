# Generated by Django 3.1 on 2022-01-29 11:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Мужской'), ('F', 'Женский'), ('NS', 'Не указан')], default='NS', max_length=10, verbose_name='Пол')),
                ...
                ('educ_type', models.CharField(blank=True, choices=[('FT', 'Очная'), ('PT', 'Заочная'), ('NS', 'Не указано')], default='NS', max_length=10, null=True, verbose_name='Форма обучения')),
